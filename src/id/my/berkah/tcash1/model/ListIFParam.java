 ...
 * @author Azec
 */
public class ListIFParam {
    private String if_id,if_no,if_date,filename,status,po_id,create_date,created_by,update_date,updated_by,submit_date,
            submited_by,approve_date,approved_by,cancel_date,canceled_by,purchase_order;

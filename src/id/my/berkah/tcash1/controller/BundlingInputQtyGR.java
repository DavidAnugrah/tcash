 ...
 * @author Azec
 */
public class BundlingInputQtyGR extends SelectorComposer<Component> {
    ...
    BundlingSelectRangeGr BundlingSelectRangeGr;
    ...
    public void selectRange() {
        ...
        System.out.println(txtBlokTo.getValue());
            Map<String, Object> map = model.doGrSelectRangebundling("SELECT",gdId,gdLine,rcvId,rcvLine,
...
//                updateQty();
    ...
    public void unselectRange() {
        ...
        if(qty.equals("null")){
            ...
            Map<String, Object> map = model.doGrSelectRangebundling("UNSELECT",gdId,gdLine,rcvId,rcvLine,
                    txtBlokFrom.getValue(), txtBlokTo.getValue(), qty.toString().replace(",", ""));
            if (map.get("outError").toString().equals("0")) {
                Messagebox.show(map.get("outMessages").toString(), "Message", Messagebox.OK, Messagebox.EXCLAMATION);
                exitForm();
...
//    }
    ...
    public void exitForm() {
        ...
        BundlingSelectRangeGr.refreshHdr();
        BundlingSelectRangeGr.refreshResult();
    }
    ...
    public void btnOk() {
        ...
        EventListener<Messagebox.ClickEvent> clickListener = new EventListener<Messagebox.ClickEvent>() {
         ...
         BundlingSelectRangeGr.refreshHdr();
        BundlingSelectRangeGr.refreshResult();
        Messagebox.show(Messages, "Bundling Message : ", new Messagebox.Button[]{
    ...
    public BundlingSelectRangeGr getBundlingSelectRangeGr() {
        return BundlingSelectRangeGr;
    }

    public void setBundlingSelectRangeGr(BundlingSelectRangeGr BundlingSelectRangeGr) {
        this.BundlingSelectRangeGr = BundlingSelectRangeGr;
    }

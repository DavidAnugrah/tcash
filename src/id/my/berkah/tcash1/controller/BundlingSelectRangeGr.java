 ...
 * @author Azec
 */
public class BundlingSelectRangeGr extends SelectorComposer<Component> {
    ...
    public void refreshHdr() {
        ...
        List<ListGrListEditSNParam> ListGrListEditSNParam = model.selectGrListEditSNbundling("", gdId, gdLine,
                rcvId, rcvLine);
        int ttl = 0;
...
//            ttl += Integer.valueOf(ListGrListEditSNParam1.getQty());
//            txtTotal.setValue(String.valueOf(ttl));
        }
        sumSelectQty("","0", "0");
    }
    ...
    public void refreshResult() {
        ...
        List<ListGrListEditSNParam> ListGrListEditSNParam = model.selectGrListEditSNbundling("RESULT", gdId, gdLine,
                rcvId, rcvLine);
        int ttl = 0;
        for (ListGrListEditSNParam ListGrListEditSNParam1 : ListGrListEditSNParam) {
            Listcell po_id = new Listcell();
...
//            ttl += Integer.valueOf(ListGrListEditSNParam1.getQty());
//            txtTotalQty.setValue(String.valueOf(ttl));
        }
        sumSelectQty("R",rcvId, rcvLine);
    }

    public void inputQtyForm(String action) {
        BundlingInputQtyGR inputQtyCtrlGR = new BundlingInputQtyGR();
        ...
        inputQtyCtrlGR.setBundlingSelectRangeGr(this);
    ...
    public void sumSelectQty(String mode,String grId,String linegrId) {
        Map<String, Object> map = model.doGrSumSelectQty(poId,
                poLineRef, grId,linegrId,gdId,gdLine);
    ...
    public void updateQty(String qty) {
        Map<String, Object> map = model.doGrSaveDtlbundling("UPDATE", rcvId, rcvLine,
                rcvDtlId, inItemid,inItemCode,"", inQty.toString().replace(",", ""), qty.toString().replace(",", ""),"",userId,inHlrMapId,"","",poId,poNo,poLineRef,
    ...
    public void unselectRange() {
         Map<String, Object> map = model.doGrUnSelectRangeValidatebundling(userId, responsibilityId,  buId,inWhId, status);
        if (map.get("outError").toString().equals("0")) {
    ...
    public void submitBtn(){
        ...
        BundlingGoodsReceipt.refreshDtl(rcvId);
    }

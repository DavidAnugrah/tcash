 ...
 * @author Azec
 */
public class GoodRecieptCTRL extends SelectorComposer<Component> {
    ...
    @Wire
    Window win_Good_Reciept, win_GD_detail;
    @Wire
    Button btnbu, btnwh, btnsup, btnsite, btnwo, btngd;
    @Wire
    Listbox listbox;
...
//        composerLov.setQueryTotal("select count(*) from table(pkg_tcash.LovSite('" + txtsupid.getText() + "'))Where supplier_number LIKE '%?%'");
        ...
        composerLov.setTitle("List Of Supplier Siste");
        composerLov.setWidth("500px");
        composerLov.setHeight("335px");
        composerLov.setPageSize(10);
        map.put("composerLov", composerLov);
...
//        }
    ...
    public void selectWO() {
        ...
        HashMap map = new HashMap<String, Object>();
        LovController composerLov = new LovController();
        composerLov.setQuery("select * from (select rownum as No, po_id as \"Purchase Id\",purchase_order as \"Purchase order\" from table(pkg_tcash_lov.LovPoGr('" + txtwhid.getText() + "','" + txtsupid.getText() + "','" + txtsupliersiteid.getText() + "',''))where (upper(po_id) like upper('?') or upper(purchase_order) like upper('?')))where No BETWEEN param1 and param2");
//        composerLov.setQueryTotal("select count(*) from table(pkg_tcash.LovPoGr('" + txtwhid.getText() + "','" + txtsupid.getText() + "','" + txtsupliersiteid.getText() + "',''))Where po_id LIKE '%?%'");
        composerLov.setQueryTotal("select count(*) from table(pkg_tcash_lov.LovPoGr('" + txtwhid.getText() + "','" + txtsupid.getValue() + "','" + txtsupliersiteid.getText() + "','')) where \n"
    ...
    public void selectGD() {
        ...
        HashMap map = new HashMap<String, Object>();
        LovController composerLov = new LovController();
        composerLov.setQuery("select * from (select rownum as No, SUPP_DELIVERY_ID as \"Supp Delivery Id\",SUPP_DELIVERY_NO as \"Supp Delivery No\" from table(pkg_tcash_lov.LovGD('" + txtpoid.getText() + "','" + userId + "','" + responsibilityId + "'))where (upper(SUPP_DELIVERY_ID) like upper('?') or upper(SUPP_DELIVERY_NO) like upper('?')))where No BETWEEN param1 and param2");
//        composerLov.setQueryTotal("select count(*) from table(pkg_tcash.LovGD('" + txtpoid.getText() + "','" + userId + "','" + responsibilityId + "'))Where po_id LIKE '%?%'");
        composerLov.setQueryTotal("select count(*) from table(pkg_tcash_lov.LovGD('" + txtpoid.getText() + "','" + userId + "','" + responsibilityId + "')) where \n"
...
//        }
    ...
    public void close() {
            win_Good_Reciept.detach();
    }

    public void selectlisthdr() {
        if (!txtsuppdeliveryid.getText().equalsIgnoreCase("")) {
            System.out.println("refesr hdr");
            display();
            List<GrListHdrParam> GrListHdrParam = model.selectGrListHdr(txtsuppdeliveryid.getValue());
...
//            txtmodifiedby.setValue(GrListHdrParam.get(0).getUpdated_by_name());
//            txtmodifieddate.setValue(GrListHdrParam.get(0).getUpdate_date());
            txtcanceledDate.setValue(GrListHdrParam.get(0).getCanceled_date());
            txtcanceledBy.setValue(GrListHdrParam.get(0).getCanceled_by_name());
    ...
    public void refreshDtl() {
        ...
        listbox.getItems().clear();
        List<ListresultGrListDtlParam> ListresultGrListDtlParam = model.selectGrListDtl(txtsuppdeliveryid.getValue());
...
//            lot_size.setLabel(ListresultGrListDtlParam1.getLot_size());
            ...
            txtlotSize.addEventListener(Events.ON_CHANGE, new EventListener() {
                        ...
                        new org.zkoss.zk.ui.event.EventListener() {
                            ...
                            public void onEvent(Event e) {
                                if (Messagebox.ON_OK.equals(e.getName())) {
                                    ...
                                    Map<String, Object> map = model.doGrSetLotSize(txtsuppdeliveryid.getValue(), rcvDtlId, txtlotSize.getValue().toString().replace(",", ""));
...
//                                        refreshDtl(txtsuppdeliveryid.getValue());
    ...
    public void editSNForm() {
        ...
        cf.setFileName("/Tcash/ListGoodReciept.zul");
...
//        System.out.println("openFormSR");
            SlcRangeGRCtrl slcRangeGRCtrl = new SlcRangeGRCtrl();
            slcRangeGRCtrl.setGoodRecieptCTRL(this);
            String lineNo = "";
            String gdId = "";
            String gdLine = "";
            String inItemid = "";
            ...
            try {
                List<Component> listCells = listbox.getSelectedItem().getChildren();
                lineNo = ((Listcell) listCells.get(1)).getLabel();
                inwoLine = ((Listcell) listCells.get(4)).getLabel();
...
//            inWhId = ((Listcell) listCells.get(19)).getLabel();
//            inCityid = ((Listcell) listCells.get(17)).getLabel();
                inHlrMapId = ((Listcell) listCells.get(28)).getLabel();
//            inOrderDate = ((Listcell) listCells.get(21)).getLabel();
//            inPoPriceUnit = ((Listcell) listCells.get(21)).getLabel();
                    ...
                    new org.zkoss.zk.ui.event.EventListener() {
                        ...
                        public void onEvent(Event e) {
                            if (Messagebox.ON_OK.equalsIgnoreCase(e.getName())) {
                                ...
                                Map<String, Object> map = model.doGrSaveHdr(modul, txtsuppdeliveryid.getValue(),
                                        txtpoid.getText(),
                                        txtWO.getText(),
                                        txtwhid.getText(),
                                        txtbuId.getText(),
    ...
    public void formAddGDLine() {
        ...
        GoodRecieptDetailCTRL goodRecieptDetailCTRL = new GoodRecieptDetailCTRL();
        goodRecieptDetailCTRL.setGoodRecieptCTRL(this);
        goodRecieptDetailCTRL.setPoId(txtpoid.getValue());
        goodRecieptDetailCTRL.setGdHdrId(txtGdId.getValue());
        goodRecieptDetailCTRL.setGrId(txtsuppdeliveryid.getValue());
        goodRecieptDetailCTRL.setPoNo(txtWO.getValue());
        goodRecieptDetailCTRL.setWhId(txtwhid.getValue());
        Map<String, Object> map = new HashMap<>();
        map.put("controller", goodRecieptDetailCTRL);
        Window window = (Window) Executions.createComponents("/Tcash/GoodRecieptDetail.zul", null, map);
        window.doModal();
    }
    ...
    public void adddetail() {
        ...
        if (txtstatus.getValue().equalsIgnoreCase("Canceled")) {
            Messagebox.show("This transaction status has been Canceled.", "Message", 1, "z-msgbox z-msgbox-exclamation");
            return;
        }
        if (txtstatus.getValue().equalsIgnoreCase("Approved")) {
            Messagebox.show("This transaction status has been Approved.", "Message", 1, "z-msgbox z-msgbox-exclamation");
            return;
        }
        if (txtstatus.getValue().equalsIgnoreCase("Confirm Receipt")) {
            Messagebox.show("This transaction status has been Confirm Receipt.", "Message", 1, "z-msgbox z-msgbox-exclamation");
            return;
        }
        ProcedureUtilImpl ci = new ProcedureUtilImpl();
        ParamCekFunction cf = new ParamCekFunction();
...
//                 selectlisthdr();
                ...
                Map<String, Object> map = model.doGrSelectGdValidate(txtGdId.getValue(), txtstatusid.getValue());
                if (map.get("outError").toString().equalsIgnoreCase("0")) {
                    formAddGDLine();
                } else {
                    Messagebox.show(map.get("outMessages").toString(), "Message", Messagebox.OK, Messagebox.EXCLAMATION);
...
//        }
//        if (listbox.getItemCount() == 0) {
//            Messagebox.show("Please add detail this transaction first", "Message", Messagebox.OK, Messagebox.EXCLAMATION);
//            return;
//        }
//       
//        if (txtstatus.getValue().equalsIgnoreCase("Confirm Receipt")) {
//            Messagebox.show("This transaction status has been Confirmed", "Message", Messagebox.OK, Messagebox.EXCLAMATION);
//            return;
//        }
//        if (txtstatus.getValue().equalsIgnoreCase("Canceled")) {
//            Messagebox.show("This transaction status has been Canceled", "Message", Messagebox.OK, Messagebox.EXCLAMATION);
//            return;
//        }
//        if(txtstatus.getValue().equalsIgnoreCase("Approved")){
//            Messagebox.show("This transaction status has been Approved.", "Message", 1, "z-msgbox z-msgbox-exclamation");
...
//        }
        ...
        if (oe.getOutError() == 0) {
            Messagebox.show("Are you sure want to Confirm  this transaction?",
                    "Question", Messagebox.OK | Messagebox.CANCEL,
                    Messagebox.QUESTION,
                    new org.zkoss.zk.ui.event.EventListener() {
                        @Override
    ...
    public void validateConfirmLine() {
        for (int i = 0; i < listbox.getItemCount(); i++) {
            ...
            System.out.println(listbox.getItemCount() + "==========");
            System.out.println(listbox.getItemAtIndex(i) + "=======");
            ...
            Map<String, Object> map = model.doGrConfirmRcvValidateLine(txtsuppdeliveryid.getValue(), lineNo, qtyRecieve.toString().replace(",", ""), gdId,
...
//        }
    ...
    public void validateSubmit() {
        ...
        Map<String, Object> map = model.doGrConfirmRcvValidate(txtsuppdeliveryid.getValue(), userId, responsibilityId,
...
//        System.out.println("Submit");
        Map<String, Object> map = model.doGrConfirmReceive(txtsuppdeliveryid.getValue(), userId);
        if (map.get("outError").toString().equalsIgnoreCase("0")) {
            Messagebox.show(map.get("outMessages").toString(), "Message", Messagebox.OK, Messagebox.INFORMATION);
            selectlisthdr();
            refreshDtl();
    ...
    public void grApproveValidate() {
        Map<String, Object> map = model.doGrApproveValidate(userId, responsibilityId,
                txtbuId.getValue(), txtwhid.getValue(), txtstatusid.getValue());
        if (map.get("outError").toString().equalsIgnoreCase("0")) {
    ...
    public void grApproveValidateLine() {
        for (int i = 0; i < listbox.getItemCount(); i++) {
            ...
            Map<String, Object> map = model.doGrApproveValidateLine(txtsuppdeliveryid.getValue(), lineNo, rcvQty.toString().replace(",", ""),
                    gdId, gdLineNo, itemId, itemCode, whLoc, whLocCode, userId);
            if (map.get("outError").toString().equalsIgnoreCase("0")) {
            } else {
                Messagebox.show(map.get("outMessages").toString(), "Message", Messagebox.OK, Messagebox.EXCLAMATION);
                return;
    ...
    public void approve() {
        Map<String, Object> map = model.doGrApprove(txtsuppdeliveryid.getValue(), txtpoid.getValue(),
                userId);
        if (map.get("outError").toString().equalsIgnoreCase("0")) {
            Messagebox.show(map.get("outMessages").toString(), "Message", Messagebox.OK, Messagebox.INFORMATION);
            selectlisthdr();
//                updateHdr();
    ...
    public void updateHdr() {
        Map<String, Object> map = model.doGrSaveHdr("UPDATE", txtsuppdeliveryid.getValue(),
                txtpoid.getText(),
                txtWO.getText(),
                txtwhid.getText(),
                txtbuId.getText(),
...
//        
//         if(txtstatus.getValue().equalsIgnoreCase("Confirm Receipt")){
//            Messagebox.show("This transaction status has been "+txtstatus.getText(), "Message", 1, "z-msgbox z-msgbox-exclamation");
//            return;
//        }
//         if(txtstatus.getValue().equalsIgnoreCase("approved")){
//            Messagebox.show("This transaction status has been "+txtstatus.getText(), "Message", 1, "z-msgbox z-msgbox-exclamation");
...
//        }
    ...
    public int gdCancelValidate() {
        Map<String, Object> map = model.doGrCancelValidate(userId, responsibilityId,
                txtbuId.getValue(), txtwhid.getValue(), txtstatusid.getValue());
        if (map.get("outError").toString().equalsIgnoreCase("0")) {
        } else {
            Messagebox.show(map.get("outMessages").toString(), "Message", Messagebox.OK, Messagebox.EXCLAMATION);
    ...
    public int gdCancel(String flag) {
        Map<String, Object> map = model.doGrCancel(txtsuppdeliveryid.getValue(), flag, userId);
        if (map.get("outError").toString().equalsIgnoreCase("0")) {
            Messagebox.show(map.get("outMessages").toString(), "Message", Messagebox.OK, Messagebox.INFORMATION);
            selectlisthdr();
        } else {
...
//        }
//        if (!txtstatus.getValue().equalsIgnoreCase("Draft")) {
//            Messagebox.show("This transaction status has been " + txtstatus.getValue(), "Goods Reciept : Message", Messagebox.OK, Messagebox.EXCLAMATION);
//            return;
//        }
//    
//        if (listbox.getItemCount() == 0) {
...
//        
                        ...
                        public void onEvent(Event e) throws ParseException {
                            if (Messagebox.ON_OK.equalsIgnoreCase(e.getName())) {
                                ...
                                try {
                                    ...
                                    Messagebox.show("Please Choose detail first", "Goods Receipt", Messagebox.OK, Messagebox.EXCLAMATION);
                                    return;
                                }

                                Map<String, Object> map = model.doGrDeleteDtl(id, delivQty.toString().replace(",", ""), gdId, gdLineNo, userId);
                                if (map.get("outError").toString().equalsIgnoreCase("0")) {
                                    Messagebox.show(map.get("outMessages").toString(), "Message", Messagebox.OK, Messagebox.INFORMATION);
                                    selectlisthdr();
                                    refreshDtl();
    ...
    public void printWo() throws IOException {
        if (txtstatus.getText().equalsIgnoreCase("")) {
            Messagebox.show("Please save this transaction first ", "Good Receipt", Messagebox.OK, Messagebox.EXCLAMATION);
            return;
        }
        if (txtstatus.getText().equalsIgnoreCase("Draft")) {
            Messagebox.show("This transaction status is still " + txtstatus.getText() + "\nPlease approve to print this receipt", "Good Receipt", Messagebox.OK, Messagebox.EXCLAMATION);
            return;
        }
        if (txtstatus.getText().equalsIgnoreCase("Confirm Receipt")) {
            Messagebox.show("This transaction status is still " + txtstatus.getText() + "\nPlease approve to print this receipt", "Good Receipt", Messagebox.OK, Messagebox.EXCLAMATION);
            return;
        }
        if (txtstatus.getText().equalsIgnoreCase("Canceled")) {
            Messagebox.show("This transaction status has been" + txtstatus.getText(), "Goods Receipt", Messagebox.OK, Messagebox.EXCLAMATION);
            return;
        }
        ...
        if (oe.getOutError() == 0) {
            ...
            if ((!this.txtsuppdeliveryid.getText().equalsIgnoreCase("")) && (txtsuppdeliveryid.getText() != null)) {
                ...
                map.put("logo", logo);
                System.out.println(map);
                JRreportWindow jRreportWindow = new JRreportWindow(this.win_Good_Reciept, true, map, "/reports/GR_Tcash_Report.jasper", "pdf", "Print Data Good Reciept", "Data Goods Reciept");
            } else {
                Messagebox.show("Please save this transaction first.", "Goods Receipt : Message", 1, "z-msgbox z-msgbox-exclamation");
            }
        } else {
            Messagebox.show(oe.getOutMessages(), "Goods Receipt : Message", Messagebox.OK, Messagebox.EXCLAMATION);
        }
    }
    ...
    public void mandatory() {
        ...
        txtWhLocCode.setStyle(LISTBOX_SELECTION_COLORS[IDefines.COLORS.MANDATORY]);
        txtWO.setStyle(LISTBOX_SELECTION_COLORS[IDefines.COLORS.MANDATORY]);
        txtGd.setStyle(LISTBOX_SELECTION_COLORS[IDefines.COLORS.MANDATORY]);
        txtlotSize.setStyle(LISTBOX_SELECTION_COLORS[IDefines.COLORS.MANDATORY]);
    }
    ...
    public void display() {
        ...
        txtWhLocCode.setStyle(LISTBOX_SELECTION_COLORS[IDefines.COLORS.DEFAULT]);
        txtWO.setStyle(LISTBOX_SELECTION_COLORS[IDefines.COLORS.DEFAULT]);
        txtGd.setStyle(LISTBOX_SELECTION_COLORS[IDefines.COLORS.DEFAULT]);
        txtlotSize.setStyle(LISTBOX_SELECTION_COLORS[IDefines.COLORS.DEFAULT]);
    }
    ...
    public void btnNew() {
        ...
        txtstatusid.setText("");
        txtWO.setText("");
        txtWhLocCode.setText("");
        txtWhLocDesc.setText("");
        txtWhLocId.setText("");
        listbox.getItems().clear();

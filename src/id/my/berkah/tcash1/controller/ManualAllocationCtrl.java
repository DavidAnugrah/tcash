 ...
 * @author arry
 */
public class ManualAllocationCtrl extends SelectorComposer<Component> {
...
//            });
    ...
    public void btnLovHlr() {
        ...
        composerLov.setQuery("select * from (select rownum as No,Block_Map_Description as \"Hlr Desc\",Item_Code as \"Item Code\",Item_Description as \"Item Description\", Lot as \"Lot\", Qty as \"Qty\",Block_From as \"Block From\",Block_To as \"Block To\",Hlr_Map_Id as \"Hlr Map Id\",Item_Loc_Id as \"Item Loc Id\",is_old as \"Is Old\" from (select Block_Map_Description,Item_Code, Item_Description,Lot,Qty,Block_From,Block_To,Hlr_Map_Id,Item_Loc_Id,is_old from table(pkg_ifm1.LovHlr(" + poId + "," + poLine + "," + orderType + ")))\n"
                + "where (upper(BLOCK_MAP_DESCRIPTION) like upper('?'))) where No BETWEEN param1 and param2 ");

        composerLov.setQueryTotal("select count(*) from table(pkg_ifm1.LovHlr(" + poId + "," + poLine + "," + orderType + ")) where \n"
...
//            selectRangeCtrl.setManualAllocationCtrl(this);
            ...
            selectRangeCtrl.setPoLineId(poLineId);

 ...
 * @author arry
 */
public class InputQtyCtrlGD extends SelectorComposer<Component> {
    ...
    public void selectRange() {
        ...
        if(qty.equals("null")){
            ...
            Map<String, Object> map = model.doGdSelectRange("SELECT",poId,poLineRef,supDelivid,lineNo,
    ...
    public void unselectRange() {
        ...
        if(qty.equals("null")){
            ...
            Map<String, Object> map = model.doGdSelectRange("UNSELECT",poId,poLineRef,supDelivid,lineNo,
                    txtBlokFrom.getValue(), txtBlokTo.getValue(), qty.toString().replace(",", ""));
            if (map.get("outError").toString().equals("0")) {
                Messagebox.show(map.get("outMessages").toString(), "Message", Messagebox.OK, Messagebox.EXCLAMATION);
                exitForm();
    ...
    public void exitForm() {
        ...
        slcRangeGDCtrl.countHdr();
        slcRangeGDCtrl.countRst();
    }
    ...
    public SlcRangeGDCtrl getSlcRangeGDCtrl() {
        return slcRangeGDCtrl;
    }

    public void setSlcRangeGDCtrl(SlcRangeGDCtrl slcRangeGDCtrl) {
        this.slcRangeGDCtrl = slcRangeGDCtrl;
    }

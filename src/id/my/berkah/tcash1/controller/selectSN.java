 ...
 * @author Azec
 */
public class selectSN extends SelectorComposer<Component> {
    ...
    public void oncreateWondow() {
        parentController = (ListSelectRange) winselectfromto.getAttribute("parentController");
    }

    @Listen("onClick=#Close1")
    public void closewindow() {
        winselectfromto.detach();
        parentController.clearparam();
        clearparam();
    }
